...
const translations = {
  ...
  ar: {
    ...
    "Suivi des quantités disponibles, des alertes et des mouvements récents.": "متابعة الكميات المتوفرة والتنبيهات والحركات الأخيرة.",
    ...
    "Référentiel des tissus, accessoires, prix et seuils de réapprovisionnement.": "مرجع الأقمشة والإكسسوارات والأسعار وحدود إعادة التوريد.",
    "Rouleaux & lots fournisseurs": "لفائف ودفعات الموردين",
    "Enregistrer un rouleau": "تسجيل لفافة",
    "Traçabilité de chaque rouleau, de sa réception jusqu'à son utilisation.": "تتبع كل لفافة من استلامها إلى استعمالها.",
    "Réceptions": "الاستلامات",
    "Enregistrer les entrées, leurs documents justificatifs et la mise à jour du stock.": "تسجيل الإدخالات ووثائقها وتحديث رصيد المخزون.",
    "Sorties vers production": "الصرف إلى الإنتاج",
    "Enregistrer une sortie": "تسجيل صرف",
    "Préparer et contrôler les matières affectées aux lots de production.": "تحضير ومراقبة المواد المخصصة لدفعات الإنتاج.",
    "Retours d'atelier": "مرتجعات الورشة",
    "Enregistrer un retour": "تسجيل إرجاع",
    "Réconcilier les matières retournées avec la sortie d'origine et leur état.": "مطابقة المواد المرجعة مع عملية الصرف الأصلية وحالتها.",
    "Inventaires": "الجرد",
    "Créer un inventaire": "إنشاء جرد",
    "Comparer le stock physique au stock système et approuver les ajustements.": "مقارنة المخزون الفعلي برصيد النظام واعتماد التسويات.",
    "Historique des mouvements": "سجل الحركات",
    "Exporter l'historique": "تصدير السجل",
    "Rechercher les entrées, sorties, retours, pertes et ajustements.": "البحث في الإدخالات والصرف والمرتجعات والفاقد والتسويات.",
    "Valorisation du stock": "قيمة المخزون",
    "Exporter la valorisation": "تصدير التقييم",
    "Estimation de la valeur du stock selon le prix d'achat de référence.": "تقدير قيمة المخزون حسب سعر الشراء المرجعي.",
    "Configurer les seuils": "ضبط الحدود",
    "Prioriser les matières sous le seuil, épuisées ou proches de la fin de rouleau.": "ترتيب المواد تحت الحد أو النافدة أو اللفائف القريبة من النفاد.",
    "Données actualisées à 08:02": "تم تحديث البيانات في 08:02",
    "Une dépense peut être affectée à un lot à l'enregistrement ou plus tard": "يمكن ربط المصروف بدفعة إنتاج عند التسجيل أو لاحقاً",
    "Les coûts sont basés sur les dépenses affectées aux lots": "التكاليف مبنية على المصروفات المرتبطة بالدفعات",
    "Pilotage des articles, des lots et des étapes de fabrication.": "إدارة المنتجات والدفعات ومراحل التصنيع.",
    ...
    "Référentiel des produits, variantes, consommations théoriques et opérations.": "مرجع المنتجات والأنواع والاستهلاك النظري والعمليات.",
    "Ajouter un article": "إضافة منتج",
    "Définir les étapes de fabrication et la tarification de chaque opération.": "تحديد مراحل التصنيع وتعريفة كل عملية.",
    "Ajouter une opération": "إضافة عملية",
    "Suivre les quantités planifiées, les responsables et les dates cibles.": "متابعة الكميات المخططة والمسؤولين والآجال المستهدفة.",
    "Comparer la consommation réelle aux besoins théoriques de chaque lot.": "مقارنة الاستهلاك الفعلي بالاحتياج النظري لكل دفعة.",
    "Saisir une consommation": "إدخال الاستهلاك",
    "Suivre les quantités produites, acceptées et rejetées par lot.": "متابعة الكميات المنتجة والمقبولة والمرفوضة لكل دفعة.",
    "Saisir un avancement": "إدخال التقدم",
    "Enregistrer les pièces non conformes et décider de leur traitement.": "تسجيل القطع غير المطابقة وتحديد معالجتها.",
    "Enregistrer un rejet": "تسجيل رفض",
    "Créer, consulter, modifier et archiver les travailleurs de l'atelier.": "إنشاء وعرض وتعديل وأرشفة عمال الورشة.",
    ...
    "Distribuer les ouvriers sur les opérations et suivre les lots de production.": "توزيع العمال على العمليات ومتابعة دفعات الإنتاج.",
    "Créer une affectation": "إنشاء تعيين",
    "Enregistrer et valider le travail réalisé par ouvrier, article, opération, quantité et période.": "تسجيل واعتماد العمل حسب العامل والمنتج والعملية والكمية والفترة.",
    "Enregistrer un travail": "تسجيل عمل",
    "Modification conservée dans l'historique": "يتم الاحتفاظ بالتعديل في السجل",
    "Annulation avec motif obligatoire": "الإلغاء يتطلب ذكر السبب",
    "Travail validé par le responsable": "تم اعتماد العمل من المسؤول",
    "Préparer, contrôler et suivre les rémunérations mensuelles des ouvriers.": "تحضير ومراقبة ومتابعة أجور العمال الشهرية.",
    ...
    "Gérer les tarifs selon le mode de rémunération enregistré.": "إدارة التعريفات حسب طريقة الدفع المسجلة.",
    "Ajouter un barème": "إضافة تعريفة",
    "Enregistrer les avances et la période de paie sur laquelle elles seront déduites.": "تسجيل التسبيقات وفترة الرواتب التي ستُخصم منها.",
    "Enregistrer une avance": "تسجيل تسبيق",
    "Enregistrer les primes par ouvrier et par période avec leur motif et leur créateur.": "تسجيل المكافآت حسب العامل والفترة والسبب ومنشئها.",
    "Enregistrer une prime": "تسجيل مكافأة",
    "Enregistrer les retenues appliquées au salaire avec leur motif et leur créateur.": "تسجيل الاقتطاعات على الراتب مع سببها ومنشئها.",
    "Enregistrer une retenue": "تسجيل اقتطاع",
    "Réviser le détail de chaque calcul avant la clôture de la période.": "مراجعة تفاصيل كل حساب قبل إغلاق الفترة.",
    "Calculer la période": "حساب الفترة",
    "Fermer une période et conserver une version fixe des calculs de paie.": "إغلاق الفترة والاحتفاظ بنسخة ثابتة من حسابات الرواتب.",
    "Clôturer septembre": "إغلاق سبتمبر",
    "Consulter et imprimer le relevé interne détaillé d'un ouvrier autorisé.": "عرض وطباعة كشف داخلي مفصل للعامل المصرح له.",
    "Imprimer / PDF": "طباعة / PDF",
    "الاطلاع والطباعة متاحان للمستخدمين المصرح لهم فقط": "الاطلاع والطباعة متاحان للمستخدمين المصرح لهم فقط",
    "Enregistrer les dépenses de l'atelier et les affecter à un lot de production.": "تسجيل مصروفات الورشة وربطها بدفعة إنتاج.",
    "Enregistrer une dépense": "تسجيل مصروف",
    "Classer les dépenses pour faciliter leur suivi et leurs rapports.": "تصنيف المصروفات لتسهيل متابعتها وإعداد تقاريرها.",
    "Ajouter une catégorie": "إضافة تصنيف",
    "Programmer et suivre les dépenses périodiques de l'atelier.": "برمجة ومتابعة المصروفات الدورية للورشة.",
    "Ajouter une dépense récurrente": "إضافة مصروف دوري",
    "Analyser les dépenses par catégorie, période et lot de production.": "تحليل المصروفات حسب التصنيف والفترة ودفعة الإنتاج.",
    "Exporter le rapport": "تصدير التقرير",
    "Comparer les dépenses affectées et le coût total des lots de production.": "مقارنة المصروفات المخصصة والتكلفة الإجمالية لدفعات الإنتاج.",
    "Exporter l'analyse": "تصدير التحليل",
    "Synthèse des quantités, alertes et valorisation du stock.": "ملخص الكميات والتنبيهات وقيمة المخزون.",
    "Synthèse des quantités planifiées, réalisées et rejetées.": "ملخص الكميات المخططة والمنجزة والمرفوضة.",
    "Comparer le travail validé par ouvrier, article et opération.": "مقارنة العمل المعتمد حسب العامل والمنتج والعملية.",
    "Synthèse des montants bruts, primes, retenues et nets dus.": "ملخص الأجور الخام والمكافآت والاقتطاعات والصافي المستحق.",
    "Rapport des dépenses par catégorie, période et lot affecté.": "تقرير المصروفات حسب التصنيف والفترة والدفعة المخصصة.",
    "Analyse du coût des lots et des dépenses qui leur sont affectées.": "تحليل تكلفة الدفعات والمصروفات المرتبطة بها.",
    "Filtres de période et de domaine": "مرشحات الفترة والمجال",
    "Gérer les comptes qui peuvent accéder à l'application.": "إدارة الحسابات التي يمكنها الوصول إلى التطبيق.",
    "Créer un utilisateur": "إنشاء مستخدم",
    "Définir les accès aux modules et aux opérations sensibles.": "تحديد الوصول إلى الوحدات والعمليات الحساسة.",
    "Créer un rôle": "إنشاء دور",
    "Configurer les paramètres généraux utilisés par l'application.": "ضبط الإعدادات العامة المستخدمة في التطبيق.",
    "Enregistrer les paramètres": "حفظ الإعدادات",
    "Consulter l'historique des actions sensibles effectuées dans l'application.": "عرض سجل العمليات الحساسة المنفذة في التطبيق.",
    ...
    "Accès réservé aux utilisateurs autorisés": "الوصول مخصص للمستخدمين المصرح لهم",
    "Net = brut + primes + régularisations positives − avances − retenues": "الصافي = الأجر الخام + المكافآت + التسويات الإيجابية − التسبيقات − الاقتطاعات",
    "À la pièce : quantités acceptées uniquement × tarif enregistré · À la journée : jours validés · Au mois : salaire fixe de la période": "بالقطعة: الكميات المقبولة فقط × التعريفة المسجلة · باليوم: أيام العمل المعتمدة · بالشهر: الراتب الثابت للفترة",
    "Consultation et impression réservées aux utilisateurs autorisés": "الاطلاع والطباعة متاحان للمستخدمين المصرح لهم فقط",
    Indicateur: "المؤشر",
    Valeur: "القيمة",
    Évolution: "التطور",
